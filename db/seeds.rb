...
Video.create(title: "Simpsons", description: "The Simpson family are cartoon characters featured in the animated television series The Simpsons. The Simpsons are a nuclear family consisting of married couple Homer and Marge and their three children Bart, Lisa and Maggie.", small_cover_url: "https://dl.dropbox.com/s/vg4xrmvbgi10cpb/simpsons_small.png", large_cover_url: "https://dl.dropbox.com/s/pqrs0i9b5bwiqs5/simpsons_large.jpg", category: cat2)
Video.create(title: "Futurama", description: "Futurama is a show about the future and when someone from the year 2000 get beamed into the future.", small_cover_url: "https://dl.dropbox.com/s/vg4xrmvbgi10cpb/simpsons_small.png", large_cover_url: "https://dl.dropbox.com/s/pqrs0i9b5bwiqs5/simpsons_large.jpg", category: cat2)
